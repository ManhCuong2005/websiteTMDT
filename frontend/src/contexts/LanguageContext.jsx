...
const translations = {
  ...
  "Minh Phát giúp bạn chọn đúng bút thử nước, lõi lọc, máy lọc và đặt thợ kiểm tra, lắp đặt, bảo trì ngay tại nhà.": "Minh Phat helps you choose the right testers, filters and purifiers, with at-home inspection, installation and maintenance.",
  "Kiểm tra định kỳ giúp máy hoạt động ổn định và đảm bảo chất lượng nước đầu ra. Lõi thô thường cần thay sau 3-9 tháng tùy nguồn nước và tần suất sử dụng.": "Regular checks keep your purifier running reliably and maintain output water quality. Pre-filters usually need replacing every 3–9 months, depending on the water source and usage.",
  "Gửi yêu cầu kiểm tra, sửa chữa, lắp đặt hoặc bảo trì. Admin sẽ thấy yêu cầu này trong màn hình quản trị.": "Send an inspection, repair, installation or maintenance request. It will appear in the admin workspace.",
  "Đã gửi yêu cầu. Minh Phát sẽ liên hệ xác nhận lịch trong thời gian sớm nhất.": "Your request has been sent. Minh Phat will contact you shortly to confirm the appointment.",
  "Thông tin tài khoản và địa chỉ mặc định sẽ được điền sẵn nếu có.": "Your account details and default address will be filled in automatically when available.",
  "Bạn cần đăng nhập để hệ thống lưu yêu cầu và admin xử lý.": "Please sign in so the system can save your request for the service team.",
  "Phù hợp khi bạn cần lắp máy mới, thay lõi lọc, kiểm tra chất lượng nước hoặc xử lý máy chảy yếu, rò rỉ.": "Ideal for new installations, filter replacement, water testing, weak flow or leak repair.",
  "Kỹ thuật viên đến tận nhà, kiểm tra vị trí và lắp đặt gọn gàng.": "A technician visits your home, checks the location and installs everything neatly.",
  "Đo nhanh TDS, tư vấn lõi lọc phù hợp với tình trạng nước thực tế.": "Quick TDS testing and filter advice tailored to your actual water conditions.",
  "Nhắc lịch thay lõi, vệ sinh máy và kiểm tra rò rỉ để dùng bền hơn.": "Filter reminders, cleaning and leak checks help your system last longer.",
  "Giải pháp kiểm tra, lắp đặt và bảo trì máy lọc nước đáng tin cậy cho mọi gia đình Việt.": "Reliable water testing, purifier installation and maintenance for every home.",
  "Chọn đúng thiết bị kiểm tra, lõi thay thế và máy lọc cho nhu cầu của bạn.": "Choose the right tester, replacement filter and purifier for your needs.",
  "Bạn thanh toán tiền mặt khi nhận và kiểm tra kiện hàng.": "Pay in cash after receiving and checking your parcel.",
  "Bằng việc đặt hàng, bạn đồng ý với chính sách mua hàng của website.": "By placing this order, you agree to the website's purchase policy.",
  "Mã giảm giá sẽ được áp dụng ở bước thanh toán.": "Coupon codes can be applied during checkout.",
  "Khám phá các sản phẩm chăm sóc nguồn nước của chúng tôi.": "Explore our clean-water care products.",
  "Giỏ hàng được lưu theo tài khoản của bạn.": "Your cart is securely saved to your account.",
  "Đăng nhập để quản lý giỏ hàng, đơn mua và địa chỉ giao hàng.": "Sign in to manage your cart, orders and delivery addresses.",
  "Theo dõi đơn hàng và lưu thông tin nhận hàng tiện lợi hơn.": "Track orders and save delivery details for a faster checkout.",
  "Mật khẩu tối thiểu 6 ký tự. Không sử dụng mật khẩu quan trọng của bạn.": "Use at least 6 characters and do not reuse an important password.",
  "Vui lòng nhập email hợp lệ trước khi xác thực gương mặt.": "Enter a valid email before using face verification.",
  "Giữ khuôn mặt trong khung, đủ sáng và không đeo khẩu trang.": "Keep your face inside the frame, in good light and without a mask.",
  "Bạn cần cho phép sử dụng camera để tiếp tục.": "Allow camera access to continue.",
  "Gương mặt đã được bảo vệ và sẵn sàng để đăng nhập.": "Face sign-in is protected and ready to use.",
  "Đăng ký bằng camera sau khi đã đăng nhập tài khoản.": "Enroll with your camera after signing in to your account.",
  "Chọn ngôn ngữ hiển thị cho toàn bộ website.": "Choose the display language for the entire website.",
  "Nhấn để đăng xuất khỏi tài khoản hiện tại.": "Sign out of the current account.",
  "Bạn có chắc chắn muốn đăng xuất không?": "Are you sure you want to sign out?",
  "Bạn chắc chắn muốn hủy đơn hàng này?": "Are you sure you want to cancel this order?",
  "Bạn có chắc chắn muốn hủy đơn hàng này không?\nHành động này không thể hoàn tác.": "Are you sure you want to cancel this order?\nThis action cannot be undone.",
  ...
  "Chỉ chấp nhận ảnh JPG, PNG hoặc WEBP": "Only JPG, PNG or WEBP images are accepted",
  "Hình ảnh không được vượt quá 5 MB": "Images must not exceed 5 MB",
  "Kỹ thuật viên kiểm tra tình trạng thực tế trước khi xử lý.": "A technician checks the actual condition before starting work.",
  "Gợi ý lõi lọc và thiết bị phù hợp với nhu cầu gia đình.": "Get filter and equipment recommendations for your household.",
  "Admin cập nhật trạng thái: đã liên hệ, đã hẹn lịch, hoàn tất.": "Track status updates from contacted and scheduled through completed.",
  "Việc được giao cũ nhất sẽ nằm trên cùng để xử lý theo đúng thứ tự.": "The oldest assigned task appears first for timely handling.",
  "Việc mới hoàn thành sẽ nằm trên cùng.": "The most recently completed task appears first.",
  "Khi bạn hoàn thành công việc, lịch sử sẽ xuất hiện ở đây.": "Completed task history will appear here.",
  "Các việc mới được admin giao sẽ xuất hiện tại đây.": "New tasks assigned by an admin will appear here.",
  "chỉ hiển thị các yêu cầu được giao cho bạn.": "only requests assigned to you are shown.",
  "Chưa có yêu cầu phù hợp với bộ lọc hiện tại.": "No requests match the current filters.",
  "Chọn nhân viên role STAFF để giao việc": "Select a staff member to assign this task",
  "Bạn không thể tự khóa tài khoản đang đăng nhập.": "You cannot lock the account you are currently using.",
  "Bạn không thể tự hạ vai trò quản trị của chính mình.": "You cannot remove your own admin role.",
  "Thông tin chi tiết đang được cập nhật.": "Detailed information is being updated.",
  "Đăng nhập để kiểm tra quyền đánh giá sản phẩm này.": "Sign in to check whether you can review this product.",
  "Chia sẻ trải nghiệm sau khi sử dụng...": "Share your experience after using this product...",
  ...
  "Thời gian nhận hàng, lưu ý giao hàng...": "Preferred delivery time or notes...",
  "Số nhà, phường/xã, quận/huyện, tỉnh/thành": "Street, ward, district, province",
  "Mô tả tình trạng máy, nguồn nước hoặc yêu cầu thêm...": "Describe the purifier, water condition or any additional request...",
  "Ví dụ: Đã thay lõi số 1, khách hẹn kiểm tra lại sau 3 tháng...": "Example: Replaced filter 1; customer requested another check in 3 months...",
  "Ví dụ: Đã gọi khách, hẹn 9h sáng thứ 7...": "Example: Called customer; appointment at 9:00 Saturday...",
  ...
  "Khám phá": "Explore",
  "Thiết bị chính hãng · Bảo hành minh bạch": "Authentic equipment · Transparent warranty",
  ...
  "Nước sạch cho cuộc sống an tâm.": "Clean water for a life with peace of mind.",
  "QUY TRÌNH ĐƠN GIẢN": "A SIMPLE PROCESS",
  "Từ nhu cầu đến nguồn nước an tâm": "From your needs to water you can trust",
  "Một quy trình rõ ràng giúp bạn dễ lựa chọn, dễ đặt lịch và luôn biết bước tiếp theo.": "A clear process makes choosing, booking and following every next step simple.",
  "Bắt đầu đặt lịch": "Start booking",
  "Chia sẻ nhu cầu": "Share your needs",
  "Cho chúng tôi biết tình trạng nguồn nước, thiết bị hoặc dịch vụ bạn đang cần.": "Tell us about your water source, equipment or the service you need.",
  "Nhận tư vấn phù hợp": "Get tailored advice",
  "Minh Phát đề xuất giải pháp rõ ràng theo nhu cầu và ngân sách thực tế.": "Minh Phat recommends a clear solution for your real needs and budget.",
  "Chọn lịch thuận tiện": "Choose a convenient time",
  "Đặt thời gian kỹ thuật viên đến kiểm tra, lắp đặt hoặc bảo trì tận nhà.": "Schedule an at-home inspection, installation or maintenance visit.",
  "An tâm sử dụng": "Enjoy peace of mind",
  "Theo dõi đơn hàng, lịch sử dịch vụ và nhận hỗ trợ xuyên suốt sau mua.": "Track orders and service history with continued after-sales support.",
  "ĐỒNG HÀNH DÀI LÂU": "LONG-TERM CARE",
  "Không chỉ bán thiết bị,": "More than equipment,",
  "chúng tôi chăm sóc cả quá trình sử dụng": "we support your entire ownership journey",
  "Từ lúc lựa chọn sản phẩm đến kiểm tra, thay lõi và bảo trì định kỳ, mọi nhu cầu đều được tiếp nhận trên cùng một hệ thống.": "From product selection to inspection, filter replacement and scheduled maintenance, every need is handled in one system.",
  ...
  "Giải thích rõ phương án, sản phẩm và các bước thực hiện trước khi khách hàng lựa chọn.": "Clear explanations of options, products and next steps before you make a decision.",
  "Chủ động thời gian": "Convenient scheduling",
  "Đặt lịch · Xác nhận": "Book · Confirm",
  "Tiếp nhận lịch trực tuyến và liên hệ xác nhận để bạn dễ sắp xếp thời gian tại nhà.": "Book online and receive confirmation so you can easily arrange your time at home.",
  "Hỗ trợ sau mua": "After-sales support",
  "Đồng hành · Tin cậy": "Continued · Reliable",
  "Thông tin đơn hàng và dịch vụ được lưu lại để quá trình hỗ trợ luôn liền mạch.": "Order and service details stay available to keep every support interaction seamless.",
  "BẠN CẦN HỖ TRỢ?": "NEED A HAND?",
  "Bắt đầu với một nguồn nước tốt hơn ngay hôm nay": "Start enjoying better water today",
  "Khám phá thiết bị phù hợp hoặc đặt lịch để đội ngũ Minh Phát kiểm tra trực tiếp tại nhà.": "Find the right equipment or book an at-home assessment with the Minh Phat team.",
  "Xem sản phẩm": "Browse products",
  "Lịch sử đặt lịch": "Service history",
  "DỊCH VỤ CỦA TÔI": "MY SERVICES",
  "Theo dõi tiến độ, cập nhật thông tin và xác nhận chất lượng sau khi kỹ thuật viên hoàn thành.": "Track progress, update details and confirm service quality after the technician finishes.",
  ...
  "Các yêu cầu dịch vụ của bạn sẽ xuất hiện tại đây.": "Your service requests will appear here.",
  "YÊU CẦU": "REQUEST",
  ...
  "Kỹ thuật viên đã báo hoàn thành": "The technician has marked this service complete",
  "Vui lòng kiểm tra kết quả trước khi xác nhận.": "Please check the result before confirming.",
  ...
  "Chia sẻ trải nghiệm để giúp Minh Phát phục vụ tốt hơn.": "Share your experience to help Minh Phat improve.",
  "Đánh giá chất lượng phục vụ": "Rate service quality",
  "Gửi nội dung khiếu nại": "Submit a dispute",
  "Mô tả phần việc chưa đạt để quản trị viên có thể liên hệ và xử lý chính xác.": "Describe what needs attention so an administrator can contact you and resolve it accurately.",
  "Nội dung cần Minh Phát hỗ trợ thêm...": "Tell Minh Phat what still needs attention...",
  "Gửi khiếu nại": "Submit dispute",
  "Đánh giá này sẽ được hiển thị công khai cùng tên của bạn tại trang chủ.": "This review will be displayed publicly on the home page with your name.",
  "Mức độ hài lòng": "Satisfaction level",
  "Nội dung đánh giá": "Review content",
  "Chia sẻ cảm nhận về kỹ thuật viên và chất lượng dịch vụ...": "Share your experience with the technician and service quality...",
  "Lưu đánh giá": "Save review",
  "Đóng": "Close",
  "Bạn có thể cập nhật địa chỉ, thời gian và ghi chú trước khi kỹ thuật viên báo hoàn thành.": "You can update the address, time and notes before the technician marks the service complete.",
  "Chỉnh sửa thông tin": "Edit details",
  "Hủy chỉnh sửa": "Cancel editing",
  "Bạn xác nhận kỹ thuật viên đã hoàn thành dịch vụ?": "Do you confirm that the technician completed the service?",
  "Đánh giá dịch vụ thực tế": "Verified service reviews",
  "Đánh giá sẽ xuất hiện tại đây sau khi khách hàng xác nhận hoàn thành và chia sẻ trải nghiệm.": "Reviews appear here after customers confirm completion and share their experience.",
  "Đặt lịch trải nghiệm dịch vụ": "Book a service",
  "ĐIỀU PHỐI DỊCH VỤ": "SERVICE OPERATIONS",
  "Yêu cầu đặt lịch": "Service requests",
  "Admin tiếp nhận, liên hệ, giao nhân viên hoặc hủy yêu cầu. Phần thực hiện do nhân viên phụ trách.": "Administrators receive, contact, assign or cancel requests. Service execution is handled by staff.",
  "Mới tiếp nhận": "New",
  "Đã giao việc": "Assigned",
  ...
  "Nội dung liên hệ hoặc lý do hủy (nếu có)...": "Contact details or cancellation reason (if any)...",
  ...
  "Bạn chắc chắn muốn hủy yêu cầu dịch vụ này?": "Are you sure you want to cancel this service request?",
  "Vui lòng chọn nhân viên trước khi giao việc.": "Select a staff member before assigning the request.",
  ...
  "Các công việc đã được khách xác nhận hoặc đã hủy.": "Tasks confirmed by customers or cancelled.",
  "Nhân viên đã báo xong và đang chờ phản hồi từ khách hàng.": "The technician has marked these complete and is awaiting customer feedback.",
  "Việc được giao cũ nhất nằm trên cùng để xử lý theo đúng thứ tự.": "The oldest assigned task appears first for timely handling.",
  "Không có việc chờ xác nhận": "No tasks awaiting confirmation",
  "Chưa có việc đã khép lại": "No closed tasks yet",
  "Công việc bạn báo hoàn thành sẽ xuất hiện tại đây.": "Tasks you mark complete will appear here.",
  ...
  "Khách đã xác nhận hoàn thành nhưng chưa gửi đánh giá.": "The customer confirmed completion but has not submitted a review yet.",
  ...
  "Đường dẫn bạn truy cập không tồn tại hoặc đã thay đổi.": "The page you requested does not exist or has moved.",
  ...
  "Theo doi don hang va luu thong tin nhan hang tien loi hon.": "Track orders and save delivery details for a faster checkout.",
  ...
  "Mã xác thực đã được gửi đến email của bạn": "A verification code has been sent to your email",
  "Ma xac thuc da duoc gui den email cua ban": "A verification code has been sent to your email",
  "Mật khẩu tối thiểu 6 ký tự. Không sử dụng mật khẩu quan trọng của bạn.": "Use at least 6 characters and do not reuse an important password.",
  "Mat khau toi thieu 6 ky tu. Khong su dung mat khau quan trong cua ban.": "Use at least 6 characters and do not reuse an important password.",
  ...
  "Kiểm tra lại thông tin trước khi gửi": "Review your details before submitting",
  ...
  "Bạn chưa có đơn hàng nào": "You have no orders yet",
  "Xem trạng thái xử lý, thông tin giao hàng và chi tiết sản phẩm trong từng đơn.": "View processing status, delivery information and item details for every order.",
  "Những đơn hàng đã đặt sẽ xuất hiện tại đây để bạn theo dõi tiến trình giao hàng.": "Placed orders will appear here so you can follow their delivery progress.",
  ...
  "Tự cập nhật mỗi 10 giây. Lần tải gần nhất": "Refreshes every 10 seconds. Last updated",
  "Chưa có đơn hàng phù hợp với bộ lọc hiện tại.": "No orders match the current filters.",
  ...
  "Nhà 4 người nên chọn máy nào?": "Which purifier is right for a family of four?",
  "Tư vấn lõi lọc cần thay": "Which filters should I replace?",
  "Ngân sách dưới 6 triệu": "Budget under 6 million VND",
  "Xin chào, mình là trợ lý tư vấn của Minh Phát. Bạn đang cần chọn máy lọc, lõi thay thế hay thiết bị kiểm tra nước?": "Hi, I'm Minh Phat's product advisor. Are you looking for a purifier, replacement filter or water tester?",
